...
class TestNakedTwins(unittest.TestCase):
    def test_naked_twins(self):
        ...
        self.assertDictEqual(solution.naked_twins(before_naked_twins), after_naked_twins)
...
class TestEnvironment(unittest.TestCase):
    ...
    def test_rows_is_implemented(self):
        self.assertEqual(solution.rows, "ABCDEFGHI")

    def test_cols_is_implemented(self):
        self.assertEqual(solution.cols, "123456789")

    def test_row_units_is_implement(self):
        self.assertEqual(len(solution.row_units), 9)

    def test_col_units_is_implement(self):
        self.assertEqual(len(solution.col_units), 9)

    def test_square_units_is_implement(self):
        self.assertEqual(len(solution.square_units), 9)

    def test_diagonal_units_is_implement(self):
        self.assertEqual(len(solution.diagonal_units), 2)
    ...
    def test_number_of_unitlist_is_29(self):
        ...
        self.assertEqual(len(solution.unit_list), 29)
